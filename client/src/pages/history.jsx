const History = () => {
  ...
  return (
    <div>
      <h3 className="font-medium text-purple-500 text-center">
        Our Scouts Pole History
      </h3>
      <div className="flex justify-center py-5">
        <div className="flex justify-around text-center md:w-6/12 w-11/12 border border-gray-100">
          <input
            className="py-1 px-2 w-full hover:outline-0"
            type="text"
            placeholder="Search your poll history"
          />
          <button type="submit" className="px-6 py-1 bg-purple-600 text-white">
            Submit
          </button>
        </div>
      </div>
