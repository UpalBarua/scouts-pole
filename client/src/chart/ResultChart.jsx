...
const ResultChart = () => {
  const data = [
    {
      option: 'option 1',
      value: 'https://i.ibb.co/HP6gsnR/614-Nlzq-VFYL-AC-SL1410.jpg',
      votes: 10,
    },
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="my-5 text-center">
        <p className="block text-3xl font-bold text-green-400">
          Poll Results :{' '}
        </p>
        <span style={{ color: 'rgb(255,255,255,30%)' }}>
          ( hover or click to show the details )
        </span>
      </div>
