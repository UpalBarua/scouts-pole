...
const Footer = () => {
  return (
    <footer className="container mx-auto flex justify-center items-center pt-24 pb-20 text-center">
      <div className="text-center text-sm">
        <Link to="/">
          <h1 className="text-xl py-2 font-extrabold shadow-sm text-white">
